    ...
    return (
        <div className='flex flex-wrap items-center justify-center md:mt-12 lg:mt-12 sm:mt-12'>
            ...
            <div className='lg:w-1/2 item-start lg:text-start sm:flex sm:flex-col text-white text-lg font-semibold pr-28 sm:p-4 sm:w-full sm:pt-12 lg:mt-0 sm:text-center md:pl-28 lg:pl-0'>
                ...
                <button onClick={handleDownloadCV} className='bg-orange-600 py-2 rounded-sm text-center cursor-pointer'>Download CV</button>
            </div>
            {showDialog && (
                <div className="fixed text-black inset-0 flex items-center justify-center bg-black bg-opacity-20 z-50">
                    <div className="bg-white p-6 rounded-md text-center relative">
                        <button onClick={handleCloseDialog} className="absolute top-0 right-0   
                        ...
                        <button onClick={handleConfirmDownload} className="bg-green-500 hover:bg-green-600 text-white px-8 py-2 rounded-md mr-2">Yes</button>
                        <button onClick={handleCancelDownload} className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-md">Cancel</button>
                    </div>
                </div>
            )}
        </div>
