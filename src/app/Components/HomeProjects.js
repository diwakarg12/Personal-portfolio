    ...
    return (
        <div className='flex justify-center mt-8 mb-8'>
            <div className='w-1/2 p-12 relative'>
                ...
                <Link href=""><Image src="/hotstar.jpg" width={600} height={300} alt="" className='opacity-80' /></Link>
            ...
            <div className='w-1/2 p-12 '>
                <div className='relative'>
                    <Image src="/whatsapp.jpg" width={500} height={100} alt="" className='mb-2 h-72 w-11/12 
                object-cover' />
                ...
                <div className='relative'>
                    <Image src="/ecommerce.webp" width={500} height={100} alt="" className='mb-2 h-72 w-11/12 object-cover ' />
