    ...
    return (
        <div className='flex flex-wrap justify-center mt-8 mb-8 md:items-center lg:items-start'>
            <div className='lg:w-1/2 lg:items-start lg:p-12 relative md:w-full md:items-center md:p-0'>
                <h1 className='text-5xl text-white font-bold mb-6'>Selected Projects</h1>
                <p className='text-lg font-medium mb-16 mr-4'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. At ipsam illum asperiores optio expedita itaque consectetur temporibus dolorem adipisci laborum!</p>
                <Link href=""><Image src="/hotstar.jpg" width={600} height={300} alt="" className='opacity-80 sm:w-11/12 sm:mx-auto md:w-full md:mx-0' /></Link>
                <div className='flex bg-black items-center justify-between lg:w-[82%] mt-4 pl-4 pr-4 absolute lg:bottom-20 bg-opacity-20 md:bottom-12 md:w-[78%] sm:hidden md:visible' style={{ backdropFilter: "blur(15px)" }} >
            ...
            <div className='lg:w-1/2 md:p-12 sm:p-4 md:w-full '>
                ...
                <div className='relative sm:w-full md:w-[97%] lg:w-full'>
                    <Image src="/ecommerce.webp" width={500} height={100} alt="" className='mb-2 md:h-72 sm:h-auto md:w-11/12 sm:full object-cover ' />
