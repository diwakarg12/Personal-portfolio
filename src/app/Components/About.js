...
const About = () => {
    return (
        <div className='sm:w-full bg-slate-800 text-slate-400 p-2 md:m-2 sm:m-0 flex flex-col items-center justify-center'>
            ...
            <Link href="/contact" className='md:w-40 sm:w-full bg-orange-500 py-2 px-4 rounded-md hover:rounded-none font-semibold flex items-center justify-center'>Hire Me <RiSendPlaneFill className="text-white text-2xl ml-1" /></Link>
        </div>
    )
}
