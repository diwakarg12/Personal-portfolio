        ...
        <form id="fcf-form-id" class="fcf-form-class" method="post" onSubmit={handleSubmit}>
            <div className={styles.formGroup}>
                ...
                <div className={styles.inputGroup}>
                    <input type="text" id="Name" name="name" value={form.name} onChange={handleChange} className={styles.formControl} required />
                </div>
            </div>
            ...
            <div className={styles.formGroup}>
                ...
                <div className={styles.inputGroup}>
                    <input type="email" id="Email" value={form.email} onChange={handleChange} name="email" className={styles.formControl} required />
                </div>
            </div>
            ...
            <div className={styles.formGroup}>
                ...
                <div className={styles.inputGroup}>
                    <textarea id="Message" name="message" value={form.message} onChange={handleChange} className={styles.formControl} rows={6} maxlength="3000" required></textarea>
                </div>
            </div>
